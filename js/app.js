...
function setup() {
    ...
    var upgradeTickRateBtn = document.getElementById("upgradetickRate")
    upgradeTickRateBtn.addEventListener('click', () => { upgrade('tickRate') });

    var upgradegrowthRateBtn = document.getElementById("upgradegrowthRate")
    upgradegrowthRateBtn.addEventListener('click', () => { upgrade('growthRate') });

    var upgrademachineSpeedBtn = document.getElementById("upgrademachineSpeed")
    upgrademachineSpeedBtn.addEventListener('click', () => { upgrade('machineSpeed') });

    var upgrademachineSizeBtn = document.getElementById("upgrademachineSize")
    upgrademachineSizeBtn.addEventListener('click', () => { upgrade('machineSize') });

    var upgradetileSizeBtn = document.getElementById("upgradetileSize")
    upgradetileSizeBtn.addEventListener('click', () => { upgrade('tileSize') });
}
